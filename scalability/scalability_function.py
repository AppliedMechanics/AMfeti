...
def create_subdomain_matrices(n_domains_x=3, n_domains_y=3, n_ele_x=10, n_ele_y=10, length=8, height=8, split_system = False):
	E_alu = 210e9
	nu_alu = 0.3
	rho_alu = 7850
	...
	mesh_dict,components_ids_list,components_list = create_subdomain_mesh_components(n_domains_x,n_domains_y,n_ele_x,n_ele_y,length,height,material,force,force_direction)
